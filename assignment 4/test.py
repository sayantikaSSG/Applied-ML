...
class TestScoreFunction(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        with open("/home/sayantika/Desktop/DS2sem4/Applied Machine Leaning/Applied-ML/assignment 4/Models/logistic_regression_best_model.pkl", 'rb') as model_file:
            cls.loaded_model = pickle.load(model_file)
        cls.test_df = pd.read_csv(r"/home/sayantika/Desktop/DS2sem4/Applied Machine Leaning/Applied-ML/test.csv")
...
class TestFlaskIntegration(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.flask_process = subprocess.Popen(['python3', 'assignment 4/app.py']) 
        time.sleep(10)
        cls.test_df = pd.read_csv(r"/home/sayantika/Desktop/DS2sem4/Applied Machine Leaning/Applied-ML/train.csv")      
